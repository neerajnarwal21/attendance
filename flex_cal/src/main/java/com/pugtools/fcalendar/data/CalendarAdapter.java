...
public class CalendarAdapter {
    ...
    public CalendarAdapter(Context context, Calendar cal, HashMap<Integer, Day.DayType> dayTypeHashMap) {
    ...
    public void refresh(HashMap<Integer, Day.DayType> dayTypeHashMap) {
        // clear data
        mItemList.clear();
        mViewList.clear();
        ...
        for (int i = offset; i < length + offset; i++) {
            ...
            if (day.getDayType() == Day.DayType.HALF ||
                    day.getDayType() == Day.DayType.SHORT) {
                imgEventTag.setVisibility(View.VISIBLE);
                imgEventTag.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.circle_small_leave));
            } else if (day.getDayType() == Day.DayType.ABSENT) {
                imgEventTag.setVisibility(View.VISIBLE);
                imgEventTag.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.circle_small_off));
            } else {
                imgEventTag.setVisibility(View.INVISIBLE);
            }
