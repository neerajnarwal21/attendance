...
public class FlexibleCalendar extends UICalendar implements DayTypeGet, DayClose {
    ...
    private HashMap<Integer, Day.DayType> dayTypeHashMap = new HashMap<>();
...
//            reload();
            ...
            mListener.onItemClick(view, day.getDay(), this);
        }
    }
    ...
    // public methods
    public void setAdapter(CalendarAdapter adapter, HashMap<Integer, Day.DayType> dayTypeHashMap) {
        mAdapter = adapter;
        adapter.setFirstDayOfWeek(getFirstDayOfWeek());
...
//        reload();
    ...
    @Override
    public void onDayMapFilled(HashMap<Integer, Day.DayType> dayTypeHashMap) {
        this.dayTypeHashMap = dayTypeHashMap;
        reload();
    }
    ...
    public interface CalendarListener {
        ...
        void onItemClick(View v, int day, DayClose dayClose);
